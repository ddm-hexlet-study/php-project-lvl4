...
@section('content')
    ...
    <div class="d-flex mb-3">
        ...
        <div>
            <div class="row g-1">
                <div class="col">
                    {{ Form::select('filter[status_id]', $statuses, null, ['placeholder' => __('views.tasks.status'), 'class' => 'form-control']) }}
                </div>
                <div class="col">
                    {{ Form::select('filter[created_by_id]', $users, null, ['placeholder' => __('views.tasks.author'), 'class' => 'form-control']) }}
                </div>
                <div class="col">
                    {{ Form::select('filter[assigned_to_id]', $users, null, ['placeholder' => __('views.tasks.executor'), 'class' => 'form-control']) }}
                </div>
                <div class="col">
